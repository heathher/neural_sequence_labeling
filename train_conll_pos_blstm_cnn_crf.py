...
tf.flags.DEFINE_integer("num_units", 200, "number of hidden units for rnn cell")
...
tf.flags.DEFINE_integer("emb_dim", 100, "embedding dimension for encoder and decoder input words/tokens")
